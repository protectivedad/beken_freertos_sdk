 ...
 * </pre>
 */
#define EM_BT_EXTAB_ADDR   (REG_EM_ET_BASE_ADDR + 0x00000000 + EM_ET_OFFSET)
 ...
 * </pre>
 */
#define EM_LE_EXTAB_ADDR   (REG_EM_ET_BASE_ADDR + 0x00000000 + EM_ET_OFFSET)
...
__INLINE void em_le_extab_pack(int elt_idx, uint8_t schprio1, uint8_t spa, uint8_t sic, uint8_t aenps, uint8_t rsvd, uint8_t iso, uint8_t status, uint8_t mode)
{
    BLE_ASSERT_ERR((((uint16_t)schprio1 << 11) & ~((uint16_t)0x0000F800)) == 0);
    BLE_ASSERT_ERR((((uint16_t)spa << 10) & ~((uint16_t)0x00000400)) == 0);
    BLE_ASSERT_ERR((((uint16_t)sic << 9) & ~((uint16_t)0x00000200)) == 0);
 ...
 * </pre>
 */
#define EM_RAWSTP0_ADDR   (REG_EM_ET_BASE_ADDR + 0x00000002 + EM_ET_OFFSET)
 ...
 * </pre>
 */
#define EM_RAWSTP1_ADDR   (REG_EM_ET_BASE_ADDR + 0x00000004 + EM_ET_OFFSET)
 ...
 * </pre>
 */
#define EM_FINESTP_ADDR   (REG_EM_ET_BASE_ADDR + 0x00000006 + EM_ET_OFFSET)
 ...
 * </pre>
 */
#define EM_CSPTR_ADDR   (REG_EM_ET_BASE_ADDR + 0x00000008 + EM_ET_OFFSET)
 ...
 * </pre>
 */
#define EM_PRIOBW_ADDR   (REG_EM_ET_BASE_ADDR + 0x0000000A + EM_ET_OFFSET)
 ...
 * </pre>
 */
#define EM_PRIOLVL_ADDR   (REG_EM_ET_BASE_ADDR + 0x0000000C + EM_ET_OFFSET)
 ...
 * </pre>
 */
#define EM_PTI_VXCHAN_ADDR   (REG_EM_ET_BASE_ADDR + 0x0000000E + EM_ET_OFFSET)
