 ...
 * </pre>
 */
#define EM_BLE_TXISOPTR_ADDR   (REG_EM_BLE_TX_ISO_DESC_BASE_ADDR + 0x00000000 + EM_BLE_TX_ISO_DESC_OFFSET)
...
__INLINE void em_ble_txisoptr_pack(int elt_idx, uint8_t txdone, uint8_t txsent, uint16_t nextptr)
{
    ...
    BLE_ASSERT_ERR((((uint16_t)txsent << 14) & ~((uint16_t)0x00004000)) == 0);
 ...
 * </pre>
 */
#define EM_BLE_TXISOCNT0_ADDR   (REG_EM_BLE_TX_ISO_DESC_BASE_ADDR + 0x00000002 + EM_BLE_TX_ISO_DESC_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_TXISOCNT1_ADDR   (REG_EM_BLE_TX_ISO_DESC_BASE_ADDR + 0x00000004 + EM_BLE_TX_ISO_DESC_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_TXISOCNT2_ADDR   (REG_EM_BLE_TX_ISO_DESC_BASE_ADDR + 0x00000006 + EM_BLE_TX_ISO_DESC_OFFSET)
...
__INLINE void em_ble_txisocnt2_pack(int elt_idx, uint8_t txflushinstant, uint8_t txpldcnt2)
{
    ...
    BLE_ASSERT_ERR((((uint16_t)txpldcnt2 << 0) & ~((uint16_t)0x0000007F)) == 0);
 ...
 * </pre>
 */
#define EM_BLE_TXISOPHM0_ADDR   (REG_EM_BLE_TX_ISO_DESC_BASE_ADDR + 0x00000008 + EM_BLE_TX_ISO_DESC_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_TXCISPH_ADDR   (REG_EM_BLE_TX_ISO_DESC_BASE_ADDR + 0x00000008 + EM_BLE_TX_ISO_DESC_OFFSET)
...
{
    BLE_ASSERT_ERR((((uint16_t)txcisrfu1 << 7) & ~((uint16_t)0x00000080)) == 0);
    BLE_ASSERT_ERR((((uint16_t)txcisnpi << 6) & ~((uint16_t)0x00000040)) == 0);
    BLE_ASSERT_ERR((((uint16_t)txcisrfu0 << 5) & ~((uint16_t)0x00000020)) == 0);
    BLE_ASSERT_ERR((((uint16_t)txcie << 4) & ~((uint16_t)0x00000010)) == 0);
    BLE_ASSERT_ERR((((uint16_t)txsn << 3) & ~((uint16_t)0x00000008)) == 0);
    BLE_ASSERT_ERR((((uint16_t)txnesn << 2) & ~((uint16_t)0x00000004)) == 0);
 ...
 * </pre>
 */
#define EM_BLE_TXBISPH_ADDR   (REG_EM_BLE_TX_ISO_DESC_BASE_ADDR + 0x00000008 + EM_BLE_TX_ISO_DESC_OFFSET)
...
{
    BLE_ASSERT_ERR((((uint16_t)txbisrfu << 6) & ~((uint16_t)0x000000C0)) == 0);
    BLE_ASSERT_ERR((((uint16_t)txcstf << 5) & ~((uint16_t)0x00000020)) == 0);
    BLE_ASSERT_ERR((((uint16_t)txcssn << 2) & ~((uint16_t)0x0000001C)) == 0);
 ...
 * </pre>
 */
#define EM_BLE_TXISOBUFPTR_ADDR   (REG_EM_BLE_TX_ISO_DESC_BASE_ADDR + 0x0000000A + EM_BLE_TX_ISO_DESC_OFFSET)
