 ...
 * </pre>
 */
#define EM_BLE_RXCNTL_ADDR   (REG_EM_BLE_RX_DESC_BASE_ADDR + 0x00000000 + EM_BLE_RX_DESC_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_RXSTATCE_ADDR   (REG_EM_BLE_RX_DESC_BASE_ADDR + 0x00000002 + EM_BLE_RX_DESC_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_RXSTATADV_ADDR   (REG_EM_BLE_RX_DESC_BASE_ADDR + 0x00000002 + EM_BLE_RX_DESC_OFFSET)
...
{
    BLE_ASSERT_ERR((((uint16_t)rxcteerr << 15) & ~((uint16_t)0x00008000)) == 0);
    BLE_ASSERT_ERR((((uint16_t)followauxptr << 12) & ~((uint16_t)0x00001000)) == 0);
    BLE_ASSERT_ERR((((uint16_t)advmodeerr << 11) & ~((uint16_t)0x00000800)) == 0);
 ...
 * </pre>
 */
#define EM_BLE_RXSTATISOM0_ADDR   (REG_EM_BLE_RX_DESC_BASE_ADDR + 0x00000002 + EM_BLE_RX_DESC_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_RXSTATCIS_ADDR   (REG_EM_BLE_RX_DESC_BASE_ADDR + 0x00000002 + EM_BLE_RX_DESC_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_RXSTATBIS_ADDR   (REG_EM_BLE_RX_DESC_BASE_ADDR + 0x00000002 + EM_BLE_RX_DESC_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_RXPHCE_ADDR   (REG_EM_BLE_RX_DESC_BASE_ADDR + 0x00000004 + EM_BLE_RX_DESC_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_RXPHADV_ADDR   (REG_EM_BLE_RX_DESC_BASE_ADDR + 0x00000004 + EM_BLE_RX_DESC_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_RXPHISOM0_ADDR   (REG_EM_BLE_RX_DESC_BASE_ADDR + 0x00000004 + EM_BLE_RX_DESC_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_RXPHCIS_ADDR   (REG_EM_BLE_RX_DESC_BASE_ADDR + 0x00000004 + EM_BLE_RX_DESC_OFFSET)
...
{
    BLE_ASSERT_ERR((((uint16_t)rxlen << 8) & ~((uint16_t)0x0000FF00)) == 0);
    BLE_ASSERT_ERR((((uint16_t)rxcisrfu1 << 7) & ~((uint16_t)0x00000080)) == 0);
    BLE_ASSERT_ERR((((uint16_t)rxcisnpi << 6) & ~((uint16_t)0x00000040)) == 0);
    BLE_ASSERT_ERR((((uint16_t)rxcisrfu0 << 5) & ~((uint16_t)0x00000020)) == 0);
    BLE_ASSERT_ERR((((uint16_t)rxcie << 4) & ~((uint16_t)0x00000010)) == 0);
    BLE_ASSERT_ERR((((uint16_t)rxsn << 3) & ~((uint16_t)0x00000008)) == 0);
    BLE_ASSERT_ERR((((uint16_t)rxnesn << 2) & ~((uint16_t)0x00000004)) == 0);
    BLE_ASSERT_ERR((((uint16_t)rxllid << 0) & ~((uint16_t)0x00000003)) == 0);
 ...
 * </pre>
 */
#define EM_BLE_RXPHBIS_ADDR   (REG_EM_BLE_RX_DESC_BASE_ADDR + 0x00000004 + EM_BLE_RX_DESC_OFFSET)
...
{
    BLE_ASSERT_ERR((((uint16_t)rxlen << 8) & ~((uint16_t)0x0000FF00)) == 0);
    BLE_ASSERT_ERR((((uint16_t)rxbisrfu << 6) & ~((uint16_t)0x000000C0)) == 0);
    BLE_ASSERT_ERR((((uint16_t)rxcstf << 5) & ~((uint16_t)0x00000020)) == 0);
    BLE_ASSERT_ERR((((uint16_t)rxcssn << 2) & ~((uint16_t)0x0000001C)) == 0);
    BLE_ASSERT_ERR((((uint16_t)rxllid << 0) & ~((uint16_t)0x00000003)) == 0);
 ...
 * </pre>
 */
#define EM_BLE_RXCHASS_ADDR   (REG_EM_BLE_RX_DESC_BASE_ADDR + 0x00000006 + EM_BLE_RX_DESC_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_RXCLKNSYNC0_ADDR   (REG_EM_BLE_RX_DESC_BASE_ADDR + 0x00000008 + EM_BLE_RX_DESC_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_RXCLKNSYNC1_ADDR   (REG_EM_BLE_RX_DESC_BASE_ADDR + 0x0000000A + EM_BLE_RX_DESC_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_RXFCNTSYNC_ADDR   (REG_EM_BLE_RX_DESC_BASE_ADDR + 0x0000000C + EM_BLE_RX_DESC_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_RXWPALPTR_ADDR   (REG_EM_BLE_RX_DESC_BASE_ADDR + 0x0000000E + EM_BLE_RX_DESC_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_RXRALPTR_ADDR   (REG_EM_BLE_RX_DESC_BASE_ADDR + 0x00000010 + EM_BLE_RX_DESC_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_RXAEHEADER_ADDR   (REG_EM_BLE_RX_DESC_BASE_ADDR + 0x00000012 + EM_BLE_RX_DESC_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_RXDATAPTR_ADDR   (REG_EM_BLE_RX_DESC_BASE_ADDR + 0x00000014 + EM_BLE_RX_DESC_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_RXPHCTE_ADDR   (REG_EM_BLE_RX_DESC_BASE_ADDR + 0x00000016 + EM_BLE_RX_DESC_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_RXCTEPTR_ADDR   (REG_EM_BLE_RX_DESC_BASE_ADDR + 0x00000018 + EM_BLE_RX_DESC_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_RXRESERVED_ADDR   (REG_EM_BLE_RX_DESC_BASE_ADDR + 0x0000001A + EM_BLE_RX_DESC_OFFSET)
