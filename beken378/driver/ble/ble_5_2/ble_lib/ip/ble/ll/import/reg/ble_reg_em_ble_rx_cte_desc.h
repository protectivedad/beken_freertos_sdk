 ...
 * </pre>
 */
#define EM_BLE_RXCTECNTL_ADDR   (REG_EM_BLE_RX_CTE_DESC_BASE_ADDR + 0x00000000 + EM_BLE_RX_CTE_DESC_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_RXCTESAMPBUF_ADDR   (REG_EM_BLE_RX_CTE_DESC_BASE_ADDR + 0x00000004 + EM_BLE_RX_CTE_DESC_OFFSET)
