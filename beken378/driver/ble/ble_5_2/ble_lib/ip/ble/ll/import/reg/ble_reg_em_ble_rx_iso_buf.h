 ...
 * </pre>
 */
#define EM_BLE_RXISOBUFSETUP_ADDR   (REG_EM_BLE_RX_ISO_BUF_BASE_ADDR + 0x00000000 + EM_BLE_RX_ISO_BUF_OFFSET)
...
__INLINE void em_ble_rxisobufsetup_pack(int elt_idx, uint8_t invl, uint8_t rxisollid, uint8_t rxisolength)
{
    ...
    BLE_ASSERT_ERR((((uint16_t)rxisollid << 8) & ~((uint16_t)0x00000300)) == 0);
 ...
 * </pre>
 */
#define EM_BLE_RXISOBUFLBL_ADDR   (REG_EM_BLE_RX_ISO_BUF_BASE_ADDR + 0x00000002 + EM_BLE_RX_ISO_BUF_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_RXISOSUBEVTCNT_ADDR   (REG_EM_BLE_RX_ISO_BUF_BASE_ADDR + 0x00000004 + EM_BLE_RX_ISO_BUF_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_RXISODATABUF_ADDR   (REG_EM_BLE_RX_ISO_BUF_BASE_ADDR + 0x00000006 + EM_BLE_RX_ISO_BUF_OFFSET)
