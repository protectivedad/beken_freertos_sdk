 ...
 * </pre>
 */
#define EM_BLE_TXISOBUFSETUP_ADDR   (REG_EM_BLE_TX_ISO_BUF_BASE_ADDR + 0x00000000 + EM_BLE_TX_ISO_BUF_OFFSET)
...
{
    BLE_ASSERT_ERR((((uint16_t)txisomute << 15) & ~((uint16_t)0x00008000)) == 0);
    BLE_ASSERT_ERR((((uint16_t)txisollid << 8) & ~((uint16_t)0x00000300)) == 0);
 ...
 * </pre>
 */
#define EM_BLE_TXISODATABUF_ADDR   (REG_EM_BLE_TX_ISO_BUF_BASE_ADDR + 0x00000002 + EM_BLE_TX_ISO_BUF_OFFSET)
