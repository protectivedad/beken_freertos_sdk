...
enum gap_device_appearance
{
    GAP_APPEARANCE_GENERIC_UNKNOWN                  = 0x000 << 6,
    GAP_APPEARANCE_GENERIC_PHONE                    = 0x001 << 6,
    GAP_APPEARANCE_GENERIC_COMPUTER                 = 0x002 << 6,
    GAP_APPEARANCE_GENERIC_WATCH                    = 0x003 << 6,
    GAP_APPEARANCE_GENERIC_CLOCK                    = 0x004 << 6,
    GAP_APPEARANCE_GENERIC_DISPLAY                  = 0x005 << 6,
    GAP_APPEARANCE_GENERIC_REMOTE_CONTROL           = 0x006 << 6,
    GAP_APPEARANCE_GENERIC_EYE_GLASSES              = 0x007 << 6,
    GAP_APPEARANCE_GENERIC_TAG                      = 0x008 << 6,
    GAP_APPEARANCE_GENERIC_KEYRING                  = 0x009 << 6,
    GAP_APPEARANCE_GENERIC_MEDIA_PLAYER             = 0x00A << 6,
    GAP_APPEARANCE_GENERIC_BARCODE_SCANNER          = 0x00B << 6,
    GAP_APPEARANCE_GENERIC_THERMOMETER              = 0x00C << 6,
    GAP_APPEARANCE_GENERIC_HEART_RATE_SENSOR        = 0x00D << 6,
    GAP_APPEARANCE_GENERIC_BLOOD_PRESSURE           = 0x00E << 6,
    GAP_APPEARANCE_GENERIC_HUMAN_INTERFACE_DEVICE   = 0x00F << 6,
    GAP_APPEARANCE_GENERIC_GLUCOSE_METER            = 0x010 << 6,
    GAP_APPEARANCE_GENERIC_RUNNING_WALKING_SENSOR   = 0x011 << 6,
    GAP_APPEARANCE_GENERIC_CYCLING                  = 0x012 << 6,
    GAP_APPEARANCE_GENERIC_CONTROL_DEVICE           = 0x013 << 6,
    GAP_APPEARANCE_GENERIC_NETWORK_DEVICE           = 0x014 << 6,
    GAP_APPEARANCE_GENERIC_SENSOR                   = 0x015 << 6,
    GAP_APPEARANCE_GENERIC_LIGHT_FIXTURES           = 0x016 << 6,
    GAP_APPEARANCE_GENERIC_FAN                      = 0x017 << 6,
    GAP_APPEARANCE_GENERIC_HVAC                     = 0x018 << 6,
    GAP_APPEARANCE_GENERIC_AIR_CONDITIONING         = 0x019 << 6,
    GAP_APPEARANCE_GENERIC_HUMIDIFIER               = 0x01A << 6,
    GAP_APPEARANCE_GENERIC_HEATING                  = 0x01B << 6,
    GAP_APPEARANCE_GENERIC_ACCESS_CONTROL           = 0x01C << 6,
    GAP_APPEARANCE_GENERIC_MOTORIZED_DEVICE         = 0x01D << 6,
    GAP_APPEARANCE_GENERIC_POWER_DEVICE             = 0x01E << 6,
    GAP_APPEARANCE_GENERIC_LIGHT_SOURCE             = 0x01F << 6,
    GAP_APPEARANCE_GENERIC_WINDOW_COVERING          = 0x020 << 6,
    GAP_APPEARANCE_GENERIC_AUDIO_SINK               = 0x021 << 6,
    GAP_APPEARANCE_GENERIC_AUDIO_SOURCE             = 0x022 << 6,
    GAP_APPEARANCE_GENERIC_DOMESTIC_APPLIANCE       = 0x024 << 6,
    GAP_APPEARANCE_GENERIC_MOTORRIZED_VEHICLE       = 0x023 << 6,
    GAP_APPEARANCE_GENERIC_WEARABLE_AUDIO_DEVICE    = 0x025 << 6,
    GAP_APPEARANCE_GENERIC_AIRCRAFT                 = 0x026 << 6,
    GAP_APPEARANCE_GENERIC_AV_EQUIPMENT             = 0x027 << 6,
    GAP_APPEARANCE_GENERIC_DISPLAY_EQUIPMENT        = 0x028 << 6,
    GAP_APPEARANCE_GENERIC_HEARING_AID              = 0x029 << 6,
    GAP_APPEARANCE_GENERIC_GAMING                   = 0x02A << 6,
    GAP_APPEARANCE_GENERIC_SIGNAGE                  = 0x02B << 6,
    GAP_APPEARANCE_GENERIC_PULSE_OXIMETER           = 0x031 << 6,
    GAP_APPEARANCE_GENERIC_WEIGHT_SCALE             = 0x032 << 6,
    GAP_APPEARANCE_GENERIC_PERSONAL_MOBILITY_DEVICE = 0x033 << 6,
    GAP_APPEARANCE_GENERIC_CONTINUOUS_GLUCOSE_MONITOR = 0x034 << 6,
    GAP_APPEARANCE_GENERIC_INSULIN_PUMP             = 0x035 << 6,
    GAP_APPEARANCE_GENERIC_MEDICATION_DELIVERY      = 0x036 << 6,
    GAP_APPEARANCE_GENERIC_SPIROMETER               = 0x037 << 6,
    GAP_APPEARANCE_GENERIC_OUTDOOR_SPORTS_ACTIVITY  = 0x051 << 6,
};
