...
#define PMU_CLK_DIV_POSI                             (20)
#define PMU_CLK_DIV_MASK                             (0x3)
#define PMU_CLK_DIV_1                                (0)
#define PMU_CLK_DIV_2                                (1)
#define PMU_CLK_DIV_4                                (2)
#define PMU_CLK_DIV_8                                (3)
...
#define RTC_WAKEUP_EN_BIT                            (1 << 31)
#define BLE_WAKEUP_EN_BIT                            (1 << 30)
#define BTDM_WAKEUP_EN_BIT                           (1 << 29)
#define DPLL_WAKEUP_EN_BIT                           (1 << 28)
#define HSSPI_WAKEUP_EN_BIT                          (1 << 27)
#define CHARGE_ARM_WAKEUP_EN_BIT                     (1 << 26)
#define QSPI_WAKEUP_EN_BIT                           (1 << 25)
#define YUV_WAKEUP_EN_BIT                            (1 << 24)
#define JPEG_WAKEUP_EN_BIT                           (1 << 23)
#define LA_ARM_WAKEUP_EN_BIT                         (1 << 14)
#define UART3_ARM_WAKEUP_EN_BIT                      (1 << 13)
#define SDIO_ARM_WAKEUP_EN_BIT                       (1 << 12)
#define AUDIO_ARM_WAKEUP_EN_BIT                      (1 << 10)
#define TIMER_ARM_WAKEUP_EN_BIT                      (1 << 8)
#else
