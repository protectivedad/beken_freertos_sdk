...
enum
{
    ...
    I2S_CMD_DMA_ISR,
    I2S_CMD_SET_SELECT_MODE,
    I2S_CMD_SET_LSB_FIRST,
    I2S_CMD_SET_RXINT_ENABLE,
    I2S_CMD_SET_TXINT_ENABLE,
    I2S_CMD_SET_RXOVR_ENABLE,
    I2S_CMD_SET_TXOVR_ENABLE,
    I2S_CMD_SET_RXFIFO_CLR,
    I2S_CMD_SET_TXFIFO_CLR,
    I2S_CMD_SET_RXINT_LEVEL,
    I2S_CMD_SET_TXINT_LEVEL,
};
