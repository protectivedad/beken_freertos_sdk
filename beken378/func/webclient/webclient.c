 ...
 * Copyright (c) 2024-2027, Beken Corporation
 *
 ...
 * 2024-06-01     Beken        add api for http fota
 */
#include "bk_webclient.h"

#if CFG_USE_WEBCLIENT
...
__maybe_unused static void bk_webclient_hex_dump(const char *s, int length)
{
    BK_LOGI(NULL, "begin print data:");
    for (int i = 0; i < length; i++)
        BK_LOGI(NULL, "%c", *(u8 *)(s+i));
    BK_LOGI(NULL, "\r\n");
}
